...
const FIRST_NAMES = [
  "Juan", "María", "Pedro", "Lucía", "Martín", "Sofía", "Diego", "Valentina",
  "Mateo", "Camila", "Santiago", "Florencia", "Nicolás", "Julieta", "Tomás",
  "Agustina", "Facundo", "Bianca", "Lautaro", "Renata", "Ignacio", "Catalina",
  "Bruno", "Emilia", "Joaquín",
];

const LAST_NAMES = [
  "Gómez", "Pérez", "Rodríguez", "Fernández", "López", "Díaz", "Martínez",
  "García", "Sánchez", "Romero", "Sosa", "Torres", "Álvarez", "Ruiz",
  "Ramírez", "Flores", "Acosta", "Benítez", "Suárez", "Medina", "Herrera",
  "Aguirre", "Núñez", "Molina", "Vega",
];
