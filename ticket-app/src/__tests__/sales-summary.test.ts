...
describe("sales-summary", () => {
  const sales: Sale[] = [
    { id: "1", buyerName: "Juan Pérez", ticketCount: 2, used: false, createdAt: "2026-05-29" },
    { id: "2", buyerName: "Ana Ruiz", ticketCount: 1, used: true, createdAt: "2026-05-29" },
    { id: "3", buyerName: "Juan Pérez", ticketCount: 1, used: false, createdAt: "2026-05-30" },
  ];
