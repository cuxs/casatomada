    ...
    <div className="relative min-h-screen bg-[#080000]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div
          ...
          style={{
            backgroundImage: "url('/manifiesta/M01.webp')",
      ...
      <div className="relative z-[1] pt-[100px] px-6 pb-20 max-w-[600px] mx-auto">
        <img
          src="/svg/manifiesta.svg"
          alt="manifiesta"
          width={747}
          height={126}
          className="w-full opacity-85 mb-[8vh]"
        />
