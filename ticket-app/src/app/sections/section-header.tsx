    ...
    <>
      <div className="sticky top-0 z-50 flex justify-between items-start px-6 py-5 pointer-events-none">
        <button
          ...
          className="pointer-events-auto cursor-pointer bg-transparent border-0 p-0"
        >
          <img
        ...
        <img
          src="/svg/arte-y-resistencia.svg"
          alt="arte y resistencia"
          width={968}
          height={105}
          className="h-[13px] opacity-80 mt-1.5"
        />
      </div>
